...
whiteKing::whiteKing(QPoint p, QGraphicsItem *parent) : abstractPiece (parent)
{
    setBPosition(p);
    setWPosition();

    QPixmap pix(":/res/piece_wk.png");
...
bool whiteKing::checkLegitMove(QPoint pnt)
{
...
void whiteKing::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    if (getIfPlayPiece()) {
